...
class ColorBloc extends Bloc<ColorEvent, ColorBlocState> {
  ColorBloc() : super(ColorBlocState.initial()) {
    on<ChangeColorEvent>(_changeColor);
  }
  void _changeColor(ChangeColorEvent event, Emitter<ColorBlocState> emit) {
